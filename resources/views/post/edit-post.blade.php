...
<div class="row my-5 justify-content-center ">
    <div class="col-md-6 flex">
        <form action="/post/update/{{ $post->id }}" enctype="multipart/form-data" method="post">
            @csrf
            @method('PATCH')
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input name="title" value="{{ old('title', $post->title) }}" type="text" class="@if($errors->has('title')) is-invalid @endif  form-control" id="title" aria-describedby="title">
              @if ($errors->has('title'))
                <div class="invalid-feedback">
                    {{$errors->first('title')}}
                </div>
            ...
            <div class="mb-3">
              ...
              <input name="price" value="{{ old('price', $post->price) }}" type="number" class="@if($errors->has('price')) is-invalid @endif  form-control" id="price">
            @if ($errors->has('price'))
                <div class="invalid-feedback">
                    {{$errors->first('price')}}
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea id="summernote" name="description" class="form-control @if($errors->has('description')) is-invalid @endif">{{ old('description', $post->description) }}</textarea>
            ...
            <div class="mb-3">
              @foreach($tags as $tag)
                ...
                <input @if(in_array($tag->id, $tag_post)) checked @endif  name="tag[]" value="{{ $tag->id }}" type="checkbox" class="form-check-input" id="exampleCheck1">
